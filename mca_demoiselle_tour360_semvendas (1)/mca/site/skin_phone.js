...
// Filename: demoiselle_phone.ggsk
// Generated ter 1. set 08:51:14 2015
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		this._planta.ggParameter={ rx:0,ry:0,a:0,sx:0.5,sy:0.5 };
		...
		hs+=cssPrefix + 'transform: ' + parameterToTransform(this._planta.ggParameter) + ';';
		hs+='opacity: 0.6;';
		...
		this._ocultar_planta.ggParameter={ rx:0,ry:0,a:0,sx:0.7,sy:0.7 };
		...
		hs+='height: 157px;';
		hs+=cssPrefix + 'transform-origin: 50% 50%;';
		hs+=cssPrefix + 'transform: ' + parameterToTransform(this._ocultar_planta.ggParameter) + ';';
		hs+='visibility: hidden;';
		hs+='cursor: pointer;';
		...
		this._exibir_planta.ggParameter={ rx:0,ry:0,a:0,sx:0.7,sy:0.7 };
		...
		hs+='height: 157px;';
		hs+=cssPrefix + 'transform-origin: 50% 50%;';
		hs+=cssPrefix + 'transform: ' + parameterToTransform(this._exibir_planta.ggParameter) + ';';
		hs+='visibility: inherit;';
		hs+='cursor: pointer;';
		...
		this._img_lavabo.ggUpdatePosition=function() {
			...
			if (this.parentNode) {
				...
				h=this.parentNode.offsetHeight;
				this.style.top=Math.floor(-209 + h/2) + 'px';
			}
		}
		hs ='position:absolute;';
		hs+='left: -148px;';
		...
		this._img_lavabo.onclick=function () {
			...
			if (flag) {
				...
				me._img_lavabo.ggParameter.sx=0.7;me._img_lavabo.ggParameter.sy=0.7;
				me._img_lavabo.style[domTransform]=parameterToTransform(me._img_lavabo.ggParameter);
			}
			me._img_lavabo.ggScaleActive=!flag;
		}
		...
		this._meni_mask.ggParameter={ rx:0,ry:0,a:0,sx:0.8,sy:0.8 };
		...
		hs+=cssPrefix + 'transform: ' + parameterToTransform(this._meni_mask.ggParameter) + ';';
		hs+='visibility: inherit;';
		...
		this._controller.ggUpdatePosition=function() {
			...
			if (this.parentNode) {
				w=this.parentNode.offsetWidth;
				this.style.left=Math.floor(-140 + w/2) + 'px';
				h=this.parentNode.offsetHeight;
		...
		this._imagem_82.ggParameter={ rx:0,ry:0,a:0,sx:0.7,sy:0.7 };
		...
		hs+=cssPrefix + 'transform: ' + parameterToTransform(this._imagem_82.ggParameter) + ';';
		hs+='visibility: inherit;';
		...
		this._quadro_84.ggVisible=false;
		...
		this._texto_880=document.createElement('div');
		this._texto_880__text=document.createElement('div');
		this._texto_880.className='ggskin ggskin_textdiv';
		this._texto_880.ggTextDiv=this._texto_880__text;
		this._texto_880.ggId="Texto 88";
		this._texto_880.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._texto_880.ggVisible=true;
		this._texto_880.className='ggskin ggskin_text';
		this._texto_880.ggType='text';
		hs ='position:absolute;';
		hs+='left: 0px;';
		hs+='top:  5px;';
		hs+='width: 187px;';
		...
		hs+=cssPrefix + 'transform-origin: 50% 50%;';
		hs+='visibility: inherit;';
		this._texto_880.setAttribute('style',hs);
		hs ='position:absolute;';
		hs+='left: 0px;';
		hs+='top:  0px;';
		hs+='width: 187px;';
		...
		hs+='padding: 0px 1px 0px 1px;';
		hs+='overflow: hidden;';
		this._texto_880__text.setAttribute('style',hs);
		this._texto_880.ggTextDiv.innerHTML="Incorpora\xe7\xe3o e Constru\xe7\xe3o:";
		this._texto_880.appendChild(this._texto_880__text);
		this._quadro_84.appendChild(this._texto_880);
		...
		this._imagem_86=document.createElement('div');
		this._imagem_86.ggId="Imagem 86";
		this._imagem_86.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._imagem_86.ggVisible=true;
		this._imagem_86.className='ggskin ggskin_image';
		this._imagem_86.ggType='image';
		hs ='position:absolute;';
		hs+='left: 9px;';
		hs+='top:  102px;';
		hs+='width: 125px;';
		...
		hs+=cssPrefix + 'transform-origin: 50% 50%;';
		hs+='visibility: inherit;';
		this._imagem_86.setAttribute('style',hs);
		this._imagem_86__img=document.createElement('img');
		this._imagem_86__img.className='ggskin ggskin_image';
		this._imagem_86__img.setAttribute('src',basePath + 'html5/control/imagem_86.png');
		this._imagem_86__img.setAttribute('style','position: absolute;top: 0px;left: 0px;-webkit-user-drag:none;');
		this._imagem_86__img.className='ggskin ggskin_image';
		this._imagem_86__img['ondragstart']=function() { return false; };
		me.player.checkLoaded.push(this._imagem_86__img);
		this._imagem_86.appendChild(this._imagem_86__img);
		this._quadro_84.appendChild(this._imagem_86);
		this._imagem_87=document.createElement('div');
		this._imagem_87.ggId="Imagem 87";
		this._imagem_87.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._imagem_87.ggVisible=true;
		this._imagem_87.className='ggskin ggskin_image';
		this._imagem_87.ggType='image';
		hs ='position:absolute;';
		hs+='left: 150px;';
		hs+='top:  112px;';
		hs+='width: 150px;';
		...
		hs+=cssPrefix + 'transform-origin: 50% 50%;';
		hs+='visibility: inherit;';
		this._imagem_87.setAttribute('style',hs);
		this._imagem_87__img=document.createElement('img');
		this._imagem_87__img.className='ggskin ggskin_image';
		this._imagem_87__img.setAttribute('src',basePath + 'html5/control/imagem_87.png');
		this._imagem_87__img.setAttribute('style','position: absolute;top: 0px;left: 0px;-webkit-user-drag:none;');
		this._imagem_87__img.className='ggskin ggskin_image';
		this._imagem_87__img['ondragstart']=function() { return false; };
		me.player.checkLoaded.push(this._imagem_87__img);
		this._imagem_87.appendChild(this._imagem_87__img);
		this._quadro_84.appendChild(this._imagem_87);
		...
		this._texto_88.ggTextDiv.innerHTML="Vendas:";
